 ...
 */
public class JsonSchemaValidateException extends PlatformRuntimeException {

    public JsonSchemaValidateException() {
        super();
    }

    public JsonSchemaValidateException(String message) {
        super(message);
    }

    public JsonSchemaValidateException(String message, Throwable cause) {
        super(message, cause);
    }

    public JsonSchemaValidateException(Throwable cause) {
        super(cause);
    }
