...
package cn.herodotus.thingsbrain.persistence.autoconfigure.manager;
...
public class PersistenceManagerConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(PersistenceManagerConfiguration.class);
