...
/**
 * <p>Description: {@link HerodotusDevice} 转 {@link Device} 转换器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2025/4/3 19:17
 */
public class ToDeviceConverter extends AbstractToSysEntityConverter<HerodotusDevice, Device> {

    private final Converter<HerodotusProduct, Product> toProductConverter;

    public ToDeviceConverter() {
        this.toProductConverter = new ToProductConverter();
    }
    ...
    @Override
    public void prepare(HerodotusDevice source, Device target) {
        target.setId(source.getDeviceId());
