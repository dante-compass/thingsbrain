...
/**
 * <p>Description: {@link HerodotusDeviceConnection} 转 {@link DeviceConnection} 转换器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2025/4/7 15:28
 */
public class ToDeviceConnectionConverter implements Converter<HerodotusDeviceConnection, DeviceConnection> {

    @Override
    public DeviceConnection convert(HerodotusDeviceConnection source) {

        DeviceConnection target = new DeviceConnection();
        target.setId(source.getConnectionId());
