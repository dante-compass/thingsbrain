...
/**
 * <p>Description: {@link HerodotusProduct} 转 {@link Product} 转换器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2025/4/2 14:34
 */
public class ToProductConverter extends AbstractToSysEntityConverter<HerodotusProduct, Product> {

    private final Converter<HerodotusProductCategory, ProductCategory> toProductCategory;

    public ToProductConverter() {
    ...
    @Override
    public void prepare(HerodotusProduct source, Product target) {
        ...
        Optional.ofNullable(source.getCategory()).ifPresent(productCategory -> target.setCategory(toProductCategory.convert(productCategory)));
    }
}
