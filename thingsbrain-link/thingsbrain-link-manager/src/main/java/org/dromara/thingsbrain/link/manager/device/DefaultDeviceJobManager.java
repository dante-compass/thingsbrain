...
/**
 * <p>Description: 默认设备任务管理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2025/6/22 16:21
 */
public class DefaultDeviceJobManager implements DeviceJobManager {

    @Override
    public TaskDetail get(String productKey, String deviceName, Job param) {
        return null;
    }

    @Override
    public Job update(String productKey, String deviceName, JobUpdate param) {
        return null;
    }
}
