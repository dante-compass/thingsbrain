...
/**
 * <p>Description: Cassandra 列式存储处理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/11/1 16:21
 */
@Component(StorageConstants.CASSANDRA_COLUMN_STORAGE)
public class CassandraColumnStorageHandler implements DataStorageHandler {
