...
/**
 * <p>Description: TDEngine 列式存储处理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/11/1 17:15
 */
@Component(StorageConstants.TDENGINE_COLUMN_STORAGE)
public class TDEngineColumnStorageHandler implements DataStorageHandler {
