...
/**
 * <p>Description: Cassandra 行式存储处理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/11/1 17:12
 */
@Component(StorageConstants.CASSANDRA_ROW_STORAGE)
public class CassandraRowStorageHandler implements DataStorageHandler {
