...
/**
 * <p>Description: TDEngine 行式存储处理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/11/1 17:16
 */
@Component(StorageConstants.TDENGINE_ROW_STORAGE)
public class TDEngineRowStorageHandler implements DataStorageHandler {
