...
/**
 * <p>Description: ClickHouse 行式存储处理器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/11/1 17:13
 */
@Component(StorageConstants.CLICKHOUSE_ROW_STORAGE)
public class ClickHouseRowStorageHandler implements DataStorageHandler {
