...
import cn.herodotus.dante.message.emqx.event.WebhookClientDisconnectedEvent;
...
public class EmqxWebhookClientDisconnectedListener extends AbstractEmqxDisconnectedListener<WebhookClientDisconnectedEvent> {
    ...
    public EmqxWebhookClientDisconnectedListener(IdentifierManager identifierManager) {
