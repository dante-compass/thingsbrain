...
public class SysThingEventPropertyPackPostInboundMessageHandler extends AbstractInboundSysMessageHandler<EventPropertyPackPost, Map<String, Object>, SpecificationPostManager> {
