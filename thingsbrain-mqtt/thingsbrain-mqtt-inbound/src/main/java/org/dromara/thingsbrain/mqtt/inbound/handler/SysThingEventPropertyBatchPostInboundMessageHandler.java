...
public class SysThingEventPropertyBatchPostInboundMessageHandler extends AbstractSysInboundMessageHandler<EventPropertyBatchPost, Map<String, Object>, SpecificationPostManager> {
