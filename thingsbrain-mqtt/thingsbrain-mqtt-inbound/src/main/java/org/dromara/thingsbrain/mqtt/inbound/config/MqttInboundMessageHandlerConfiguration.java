...
import org.dromara.thingsbrain.mqtt.inbound.definition.handler.ExtInboundMessageHandler;
import org.dromara.thingsbrain.mqtt.inbound.definition.handler.OtaInboundMessageHandler;
...
/**
 * <p>Description: Mqtt 入站消息处理器配置 </p>
 *
...
class MqttInboundMessageHandlerConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(MqttInboundMessageHandlerConfiguration.class);

    @PostConstruct
    public void postConstruct() {
        log.debug("[ThingsBrain] |- Module [Mqtt Message Handler] Configure.");
    }
