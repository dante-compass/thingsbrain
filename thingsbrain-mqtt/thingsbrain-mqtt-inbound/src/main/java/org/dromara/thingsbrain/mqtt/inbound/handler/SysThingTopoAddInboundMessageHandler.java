...
public class SysThingTopoAddInboundMessageHandler extends AbstractSysInboundMessageHandler<List<Signature>, List<Identifier>, SubsetTopoManager> {
    ...
    @Override
    protected TypeReference<LinkSysRequest<List<Signature>>> getTypeReference() {
        return typeReference;
    }

    @Override
    protected ThrowableBiFunction<CompleteIdentifier, List<Signature>, List<Identifier>, InboundMessageProcessingException> getFunction(SubsetTopoManager subsetTopoManager) {
        return (identity, param) -> subsetTopoManager.add(identity.getProductKey(), identity.getDeviceName(), param);
    }
}
