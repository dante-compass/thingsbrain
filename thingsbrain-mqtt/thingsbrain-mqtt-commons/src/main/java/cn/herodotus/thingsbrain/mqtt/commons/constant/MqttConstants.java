 ...
 * @date : 2026/5/3 17:03
 */
public interface MqttConstants extends BaseConstants {

    String SHADOW_TOPIC_TEMPLATE__UPDATE = "shadow/update/${productKey}/${deviceName}";
    String SHADOW_TOPIC_TEMPLATE__GET = "shadow/get/${productKey}/${deviceName}";
