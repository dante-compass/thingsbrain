 ...
 * @date : 2025/6/8 17:50
 */
public class MqttDeviceShadowService {
    ...
    public MqttDeviceShadowService(DeviceShadowManager deviceShadowManager, MqttOutboundMessagePublisher mqttOutboundMessagePublisher) {
    ...
    public void update(String productKey, String deviceName, Map<String, Object> data, Integer version) {
        ...
        ShadowResponse response = deviceShadowManager.update(productKey, deviceName, request)
                .map(deviceShadowManager::read)
